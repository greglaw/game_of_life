...
const MAX_SCORE = 100;
const MAX_SCORE_NEIGHBOR_COUNT = 2;
const MIN_SCORE_RATIO_FOR_LIFE = .1;
const MAX_SCORE_RATIO_FOR_LIFE = .4;
...
class Cell {
  ...
  _hasHighScoreNeighbors(neighbors) {
    ...
    return aboveMaxNeighbors >= MAX_SCORE_NEIGHBOR_COUNT;
  }
  ...
  constructor(sizeX, sizeY) {
    ...
    for (var i = 0; i < sizeX; i++) {
      ...
      for (var j = 0; j < sizeY; j++) {
        this.grid[i][j] = new Cell(i, j, 0, 0, false, false);
      }
    }
  }
